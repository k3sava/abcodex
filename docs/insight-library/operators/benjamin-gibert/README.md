...
slug: benjamin-gibert
roles:
  - GTM Strategist; collaborator with Maja Voje on AI-native content engineering work
  - Writer at GTM Strategist on agent design and content systems
domains_active: [ai-native, gtm, pmm, engineering]
...
## Cards
- `ins_rich-context-beats-sophisticated-agents`, Simple agents reading rich, specific context outperform complex agents reading thin context (with Maja Voje, 2026-05-01) [Tier B]
