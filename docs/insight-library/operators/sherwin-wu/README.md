...
slug: sherwin-wu
roles:
  - Head of Engineering, OpenAI API and Developer Platform
domains_active: [engineering, ai-native, leadership]
captured_first: 2026-05-01
external:
  linkedin: https://www.linkedin.com/in/sherwinwu
---
...
- **Build for the next model.** Current-model scaffolding will be eaten.
- **Top performers benefit disproportionately.** Spread widens with AI tools.
