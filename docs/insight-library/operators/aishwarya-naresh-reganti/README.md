...
slug: aishwarya-naresh-reganti
roles:
  - AI engineer / researcher
  - Co-presenter with Kiriti Badam on AI product design
domains_active: [ai-native, product, engineering]
...
- **Continuous Calibration, Continuous Development.** The replacement operating loop.
- **Transparency in uncertainty.** Confidence scores beat opaque authority.
