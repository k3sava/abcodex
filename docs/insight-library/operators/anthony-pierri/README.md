...
slug: anthony-pierri
roles:
  - Co-founder of Fletch PMM
  - helps horizontal PLG startups turn homepage messaging into sales machines
...
## Cards
- `ins_homepage-five-second-trinity`, B2B homepages must communicate use case, alternative, and result in five seconds [Tier B]
