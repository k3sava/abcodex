---
id: ins_brand-gap-five-disciplines
operator: Marty Neumeier
operator_role: Author The Brand Gap, Zag, The Brand Flip
source_url: https://www.martyneumeier.com/
source_type: book
source_title: "The Brand Gap — Differentiate, Collaborate, Innovate, Validate, Cultivate"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [pmm, marketing, design-ux]
lifecycle: [positioning, messaging-narrative, ownership-org]
...
## Conditions
Holds when:
- The brand operates in a market where customer-perceived differentiation matters.
- Leadership has authority to bridge strategy and creative functions (or hire both).

Fails when:
- Pure-product-led companies where the brand is downstream of product behavior.
- Categories where regulation flattens differentiation.
