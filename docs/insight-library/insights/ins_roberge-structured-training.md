---
id: ins_roberge-structured-training
operator: Mark Roberge
operator_role: Former CRO HubSpot (employee #4); Senior Lecturer Harvard Business School; author The Sales Acceleration Formula
source_url: https://www.markroberge.com/
source_type: book
source_title: "The Sales Acceleration Formula — The Training Formula"
source_date: 2015-03-23
captured_date: 2026-05-05
domain: [sales-cs, gtm, leadership]
lifecycle: [hiring-team-design, training-development, ramp-design]
maturity: applied
artifact_class: playbook
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_roberge-sales-as-engineering-discipline, ins_skok-sales-rep-failure-rate]
...
## Conditions
Holds when:
- Buyer personas and buyer journeys are stable enough to be documented (typically post-PMF).
- The org has the management capacity to assess certifications against rubrics.
- Top reps can articulate their playbook well enough to be encoded (or coaches can extract it).

Fails when:
- Highly bespoke enterprise sales where each deal is sui generis and templates underfit.
- Very early-stage companies where the buyer persona is still being discovered.
- Organisations where managers don't have time or skill to run certifications, leaving them as paper exercises.
