---
id: ins_kill-things-to-build-trust
...
score: { originality: 5, specificity: 4, evidence: 3, transferability: 5, source: 5 }
tier: A
related: [ins_influence-is-discovery-not-conviction]
...
## Cross-references
- `ins_influence-is-discovery-not-conviction`, the broader pattern
- `ins_kill-criteria-make-pre-mortems-real`, the upstream commitment that makes kills uncontroversial
