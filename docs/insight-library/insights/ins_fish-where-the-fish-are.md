---
id: ins_fish-where-the-fish-are
operator: Andrew Wilkinson
operator_role: Founder, Tiny; co-founder MetaLab; bootstrapped portfolio operator
...
tier: A
related: [ins_willingness-to-pay-by-segment]
...
## Cross-references
- `ins_willingness-to-pay-by-segment`, the pricing variable inside niche selection
