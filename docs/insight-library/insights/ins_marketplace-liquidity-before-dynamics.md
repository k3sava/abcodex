---
id: ins_marketplace-liquidity-before-dynamics
...
domain: [product, growth-demand]
lifecycle: [strategy-bets, growth-loops]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 4, source: 5 }
tier: A
related: [ins_peer-mentorship-supply-scaling]
...
## Cross-references
- `ins_peer-mentorship-supply-scaling`, the supply-side scaling pattern that supports liquidity work
