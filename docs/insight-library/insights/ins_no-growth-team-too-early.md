...
domain: [growth-demand, leadership]
lifecycle: [hiring-team-design, strategy-bets]
maturity: applied
...
## Cross-references
- `ins_earned-channels-over-algorithm-channels`, the kind of work the right growth hire pursues
