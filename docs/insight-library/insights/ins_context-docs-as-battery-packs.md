---
id: ins_context-docs-as-battery-packs
...
source_type: thread
source_title: Context documents need clear owners and act like battery packs for AI workflows
...
tier: B
related: [ins_context-engineering-beats-prompt-engineering]
