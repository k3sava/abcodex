---
id: ins_kill-criteria-make-pre-mortems-real
operator: Annie Duke
...
tier: A
related: [ins_make-intuition-explicit, ins_no-such-thing-as-long-feedback-loop]
...
## Cross-references
- `ins_make-intuition-explicit`, the broader practice
- `ins_no-such-thing-as-long-feedback-loop`, the measurement complement
