---
id: ins_relational-keywords-replace-internal-language
...
lifecycle: [voc-research, messaging-narrative]
maturity: applied
...
## Conditions
Holds when:
- The interviews are warm-introduced by the client (not cold-recruited), so customers speak candidly.
...
## Evidence
> "The 'tell me a little bit more about that' question, which she considers the most powerful in any interviewer's toolkit, and always ending with 'is there anything else I should know?' which consistently produces the greatest insights and most concise language."
...
- SEO keyword research starts from interview transcripts, not Ahrefs alone.
- "Anything else I should know?" appears as the closing question in every research script.
