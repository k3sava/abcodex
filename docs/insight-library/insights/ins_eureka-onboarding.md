...
## Conditions
Holds when:
- The product is genuinely PLG with self-serve activation.
- The team can identify a specific Eureka moment with behavioral evidence.

Fails when:
- High-touch enterprise sales where activation runs through CSMs not product UX.
- Products where value compounds over months and "first Eureka" is a misleading frame.
...
- Onboarding-flow design starts from the Eureka moment and works backward.
- Time-to-first-value is a tracked metric, with explicit targets per cohort.
