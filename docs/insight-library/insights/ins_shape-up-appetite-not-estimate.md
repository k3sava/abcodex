---
id: ins_shape-up-appetite-not-estimate
operator: Jason Fried
operator_role: Co-founder & CEO 37signals (Basecamp, HEY, ONCE)
source_url: https://basecamp.com/shapeup
source_type: book
source_title: "Shape Up — appetite, not estimation; six-week cycles; no backlog"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [product, leadership, engineering]
lifecycle: [planning-resourcing, process-cadence]
maturity: applied
...
## Conditions
Holds when:
- Leadership is willing to discard ideas instead of saving them in a backlog.
- The team is small enough (2-3 per project) that self-organization replaces process overhead.

Fails when:
- Highly regulated build environments where standups and audit trails are required.
- Multi-team dependency-heavy projects where 6-week boundaries don't align across the org.
