...
source_type: thread
source_title: 'Uddhav Parab — Creative Director at Interactive Avenues'
...
Holds for creative agencies where juniors have enough talent to handle real campaigns with direction. Fails in shops where juniors haven't developed the craft yet.
