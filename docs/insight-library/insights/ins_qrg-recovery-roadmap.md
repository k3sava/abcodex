---
id: ins_qrg-recovery-roadmap
operator: Marie Haynes
operator_role: Founder Marie Haynes Consulting; Google algorithm-recovery authority
source_url: https://www.mariehaynes.com/
source_type: essay
source_title: "The Google Quality Rater Guidelines and E-A-T"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [content, growth-demand, marketing]
lifecycle: [content, risk-quality]
maturity: applied
...
## Conditions
Holds when:
- The site operates in YMYL or expertise-sensitive categories where the QRG most applies.
- The team can credibly add author credentials and primary-source citations.

Fails when:
- Programmatic-content sites where author attribution feels manufactured.
- Penalties driven by technical or link-spam issues rather than quality signals.
...
- Author bios link to credentials and external proof.
- Content pruning is part of recovery plan, not just additions.
...
## Cross-references
- ins_eeat-quality-rater-perspective, adjacent operator (Cyrus Shepard)
