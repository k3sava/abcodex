...
uses_cards: [ins_homepage-five-second-trinity, ins_friction-as-feature]
originating_operators: [anthony-pierri, amole-naik]
secondary_sources:
...
- **Pain-Solution-Proof interleave** (`ins_pain-solution-proof-interleaved-pitch`).
...
- **Friction as feature** (`ins_friction-as-feature`): add friction when it helps users self-qualify.
...
- 5-second tests: show the page for 5 seconds, ask what the product does (`ins_homepage-five-second-trinity`).
