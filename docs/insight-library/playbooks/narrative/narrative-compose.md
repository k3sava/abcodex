...
uses_cards: [ins_old-game-to-new-game-narrative, ins_company-story-is-the-strategy, ins_market-to-product-product-to-market]
originating_operators: [andy-raskin, april-dunford]
secondary_sources:
  - flywheel/skills/narrative-compose/SKILL.md
