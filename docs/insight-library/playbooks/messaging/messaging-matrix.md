...
### 1. Lock the champion. Situation, not just job title.
...
### 2. Mine customer interviews for the actual language.
...
### 3. Map the champion's situation. Then narrow to the exact pain.
...
### 4. Document the old way. This is what the Setup is about.
...
### 5. Choose the comparator. This determines the message architecture.
...
### 7. Write the overall positioning paragraph. One-liner, then expand.
