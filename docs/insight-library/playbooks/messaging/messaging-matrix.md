...
uses_cards: [ins_jtbd-interviews-surface-customer-language, ins_ask-revenue-impact-how-much, ins_no-decision-is-the-real-competitor, ins_setup-follow-through-pitch, ins_position-against-real-not-ghost-competitors, ins_kesava-mandiga-repositioning-commits-to-one-buyer, ins_b2b-buyer-emotion-personal-stakes, ins_homepage-five-second-trinity, ins_pain-solution-proof-interleaved-pitch, ins_content-as-social-currency, ins_messaging-equation-personalization-tiers, ins_company-story-is-the-strategy, ins_sameness-perception-is-the-differentiation-barrier, ins_test-positioning-in-live-sales-pitch, ins_market-to-product-product-to-market]
uses_patterns: [pat_buyer-mindset-not-product-features, pat_status-quo-is-the-competitor, pat_make-implicit-explicit, pat_narrative-as-strategy, pat_differentiation-vs-sameness, pat_frontline-as-pmm-substrate]
uses_contradictions: [con_no-decision-vs-named-competitor]
originating_operators: [april-dunford, anthony-pierri, bob-moesta, andy-raskin, mihika-kapoor, martina-lauchengco, kesava-mandiga, dave-gerhardt, john-barrows, richard-king, tommy-walker, gartner]
---

# Messaging matrix and homepage rollout

A messaging matrix turns a locked positioning document into the system every other surface copies from: champion, value matrix, messaging house, core narrative, homepage, and rollout. Quality bar: a rep, a paid ad, and the homepage hero say the same thing about the same product on the same day, and every line on the page traces back to a phrase a real buyer used.

Positioning is the bet. Messaging is the system built on the bet, and copy is the words on the page. Three different jobs. This playbook is the middle layer. Run it after positioning is locked, before any homepage rewrite, sales-deck refresh, or paid-channel push, and re-run it after a real shift in ICP, product, or competitor set.
...
### 1. Lock the champion as a situation, not a job title.
...
The situation layer is the one most messaging skips. Two people with the same title can have completely different buying situations. A sales manager at a 20-person startup who just missed a quarter has different urgency than a manager at a 200-person company tuning an already-working process. Same persona, different situation, different message. `pat_buyer-mindset-not-product-features`
...
Kesava Mandiga's Wingman repositioning is the cleanest proof. The homepage moved from "Conversation intelligence for fast-growing sales teams" to "Your Revenue Accelerator" and conversions doubled. The lift came from cutting the other three buyers they had been hedging for, not from the words. `ins_kesava-mandiga-repositioning-commits-to-one-buyer`
...
### 2. Mine the interviews for the buyer's actual language, verbatim.
...
> `ins_market-to-product-product-to-market`

### 3. Narrow the champion's situation to the exact pain.
...
Instead of "improve team productivity," the situation is "we have 8 reps calling the same prospect list, no way to see who talked to whom, and we lose deals because two reps call the same person in one day." That situation has a message. The first one does not. `pat_make-implicit-explicit`

### 4. Document the old way. This is the Setup the buyer needs first.
...
Document the Setup before writing any product messaging. If the Setup lands, the product claims follow. If the Setup is weak, no feature list compensates. `ins_setup-follow-through-pitch`
...
> · April Dunford, LinkedIn, 2026-04-20
> `ins_position-against-real-not-ghost-competitors`
...
### 6. Build the value matrix per persona, not per feature.
...
Features connect to benefits through capabilities. The capability is what the user does. The feature is what enables it. The benefit is what changes. Most messaging jumps feature to benefit and skips the capability, leaving the buyer to make the connection. Do not make them. `pat_make-implicit-explicit`
...
> · Richard King, The one (simple) rule to better messaging, 2026-04-10
> `ins_ask-revenue-impact-how-much`

### 7. Write the overall positioning paragraph. One-liner first, then expand.
...
2. Who is it for? (champion in situation)
3. What does it replace? (the comparator from step 5)
4. Why is it better? (the differentiator)
...
This is Anthony Pierri's homepage rule: lead with the use case, the current alternative, and the result, not with vision or abstract benefits. `ins_homepage-five-second-trinity`
...
The emotional frame is not decoration. At larger contract sizes, the buyer is reading you for personal-career stakes, not just ROI. `ins_b2b-buyer-emotion-personal-stakes`
...
> · Andy Raskin, story-is-strategy, 2026-04
> `ins_company-story-is-the-strategy`

Set a monthly audit: compare the sales deck, the homepage hero, and the most recent release notes. Do they share the same problem framing and the same differentiator claim? When they diverge, fix it before the next campaign launches. `pat_narrative-as-strategy`
...
Lead with capability, what someone actually does, not aspirational outcomes. "Build pipeline faster" is an aspiration. "Answer every inbound call in 2 seconds and log it to your CRM automatically" is a capability. The capability converts. `pat_buyer-mindset-not-product-features`
...
Mihika Kapoor built FigJam's launches and her current zero-to-one launch on this interleaving, where a single shared artifact replaces parallel research, design, and product decks. `ins_pain-solution-proof-interleaved-pitch`
...
Remember who shares the page. The buyer who reads your content is often not the buyer who decides. They forward it into a Slack channel where the decision happens. Design the proof so a senior IC looks smart sharing it, not so a VP skips it as sales material. `pat_buyer-mindset-not-product-features`

That is Tommy Walker's point: content is a form of social currency people use to express identity and raise their professional standing, so the buyer shares what makes them look smart inside their org. `ins_content-as-social-currency`
...
Before the homepage goes live, test the hero with five people outside your team. Ask them: what does this product do, who is it for, and what does it replace? If they cannot answer all three from the hero alone, rewrite it. If the differentiators land internally but not externally, you positioned for yourselves, not for buyers. `pat_differentiation-vs-sameness`
...
The sales team detects messaging failure months before any dashboard does. Build the rep-input loop from day one: a weekly objection log, a competitive Slack channel, call-shadowing twice a month. Without that loop, messaging drift accumulates silently. `pat_frontline-as-pmm-substrate`
...
- **Hero leads with aspirational outcomes.** "Build pipeline faster" tells buyers nothing about what the product does. Lead with the capability. `pat_buyer-mindset-not-product-features`
- **Hedging across personas.** Writing for RevOps and AEs and managers at once clarifies for nobody. Pick the champion and lose the others on purpose. `ins_kesava-mandiga-repositioning-commits-to-one-buyer`
- **Targeting the budget holder.** The person who signs is not the person who felt the pain. Write for the champion.
- **Paraphrased buyer language.** A summarizer smooths the exact phrase into a clean theme and the copy stops resonating. Mirror the words. `ins_jtbd-interviews-surface-customer-language`
- **Status-quo blindness.** Mapping competitors but not inertia. When 40 to 60% of losses are to no decision, a purely competitive message misdirects most of the work. `pat_status-quo-is-the-competitor` `con_no-decision-vs-named-competitor`
- **Ghost competitors.** Positioning against an alternative the buyer never considers. Use what sales loses to this quarter. `ins_position-against-real-not-ghost-competitors`
- **Feature overload, no capability bridge.** The buyer cannot connect the feature to their job. Show the action. `pat_make-implicit-explicit`
- **Differentiation that only lands internally.** Differentiators the team loves but buyers feel as sameness. Test externally before launch. `pat_differentiation-vs-sameness`
- **Skipping the rollout tracker.** Messaging gets written but never deployed page by page.
- **No narrative-drift audit.** The sales deck, homepage, and release notes diverge within a quarter. Catch it monthly. `pat_narrative-as-strategy`
- **Skipping the rep-input loop.** Sales hears messaging failures in language first, months before dashboards. `pat_frontline-as-pmm-substrate`

## What you get

1. Champion profile: company type, persona, JTBD situation, emotional stakes.
2. Verbatim language bank: buyer phrases pulled from 5+ interviews, traceable to transcripts.
3. Setup brief: insight, alternatives (including status quo), perfect world.
4. Comparator decision: the named alternative and the message architecture it sets.
5. Value matrix per persona: Pain · Benefit · Capability · Message.
6. Positioning paragraph: one-liner that passes the four-question test, plus the expansion.
7. Messaging house: three pillars with feature-level evidence and a proof point each.
8. Core narrative: one paragraph, the seed for every channel.
9. Angle comparison sheet: 3+ options evaluated against the ICP.
10. Homepage wireframe with copy for each of the eight sections.
11. Rollout tracker: page, score, status, owner.
12. Monthly narrative-drift audit: scheduled, with a named owner.
