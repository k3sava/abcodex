...
domains: [strategy, founder-craft, leadership]
---

# Power-law concentration vs. barbell diversification
...
- **Thiel's stance is right when** the operator has strong reason to know which bet is the head. In venture, the partner who can pick the right deal concentrates and wins; in distribution, the founder who can pick the right channel concentrates and wins. Concentration only works if the picking is good.

- **Taleb's stance is right when** the operator does *not* have confidence in picking the head. If the modal distribution is uncertain (most strategic and personal-life domains), spreading across many small high-convexity bets captures the upside without staking the operator's survival on a single bet that might miss.
...
- ins_thiel-power-law, Peter Thiel
- ins_thiel-vertical-vs-horizontal-progress, Peter Thiel
- ins_taleb-barbell-strategy, Nassim Taleb
- ins_antifragile-barbell, Nassim Taleb (existing canonical card)
