...
convergence_count: 3
tier: A
uses_cards: [ins_agents-are-the-new-product-user, ins_machine-customers-displace-storefront-interactions, ins_nlx-is-the-new-ux, ins_dark-factory-pattern]
domains: [product, design, ai-native]
---
...
## Operators
- Elena Verna, `ins_agents-are-the-new-product-user`. Agents are first-class product users; design for output reliability, not navigation.
- Aparna Chennapragada, `ins_nlx-is-the-new-ux`. Natural language is the interface; conversation flow is the design surface.
- Gartner, `ins_machine-customers-displace-storefront-interactions`. By 2028, 20% of human-readable storefront interactions will be replaced by AI agent machine customers.
- Simon Willison, `ins_dark-factory-pattern`. The dark factory: nobody reads the code, gated by a simulated QA swarm, the production analog (agents producing for agents).
