...
convergence_count: 3
tier: B
uses_cards: [ins_specificity-becomes-profitable, ins_willingness-to-pay-by-segment, ins_fish-where-the-fish-are, ins_marketplace-liquidity-before-dynamics, ins_tech-stack-renewal-window-play]
domains: [growth, gtm, pmm]
---
...
## Operators
- Eric Seufert, `ins_specificity-becomes-profitable`. AI makes specificity profitable; the Pareto distribution flattens at the long tail.
- Andrew Wilkinson, `ins_willingness-to-pay-by-segment` and `ins_fish-where-the-fish-are`. Same service, different segment, 5x price; pick a niche where the fish are.
- Florin Tatulea, `ins_tech-stack-renewal-window-play`. Combine tech-stack signal with contract-renewal window for ~5x outbound conversion.
- Benjamin Lauzier, `ins_marketplace-liquidity-before-dynamics`. Pre-PMF, pick the hardest side and nail liquidity, same shape: get specific before generalising.
