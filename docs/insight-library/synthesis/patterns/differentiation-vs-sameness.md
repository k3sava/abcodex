...
## Operators
- Ayo Omojola, `ins_different-better-and-matters`. Differentiation requires three checks, not one.
- Gartner, `ins_sameness-perception-is-the-differentiation-barrier`. Buyers see sameness; test differentiators with external audiences before launch.
- April Dunford, `ins_test-positioning-in-live-sales-pitch`. Marketing stories are unfalsified theory until they survive a live pitch.
- Krithika Shankarraman, `ins_use-case-epiphany-as-marketing-job`. The "matters viscerally" check is the use-case epiphany.
