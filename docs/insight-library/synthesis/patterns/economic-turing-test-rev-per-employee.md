...
convergence_count: 3
tier: A
uses_cards: [ins_economic-turing-test-for-ai, ins_outcomes-pricing-restructures-saas, ins_underfund-deliberately, ins_top-performers-benefit-disproportionately]
domains: [ai-native, gtm, leadership]
---
...
## Operators
- Benjamin Mann (Anthropic), `ins_economic-turing-test-for-ai`. The benchmark: would you hire it if you didn't know?
- Bret Taylor (Sierra), `ins_outcomes-pricing-restructures-saas`. Agents push SaaS from per-seat to outcomes-based pricing; the incentive flip changes everything.
- Boris Cherny, `ins_underfund-deliberately`. Underfund teams so AI substrate, not headcount, absorbs the work, the operational expression of the rev-per-employee bet.
- Sherwin Wu, `ins_top-performers-benefit-disproportionately`. AI tools widen the spread between top and bottom performers; invest in top performers.
