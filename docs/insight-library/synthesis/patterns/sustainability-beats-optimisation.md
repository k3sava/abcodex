...
convergence_count: 5
tier: A
uses_cards: [ins_housel-pretty-good-strategy-30-years, ins_housel-reasonable-beats-rational, ins_housel-doing-nothing-during-crisis, ins_getting-vs-staying-wealthy, ins_career-sequence-leverage-then-judgment, ins_taleb-via-negativa, ins_taleb-iatrogenics, ins_taleb-lindy-effect, ins_circle-of-competence, ins_mental-models-as-os-not-library, ins_sinek-infinite-game]
domains: [strategy, leadership, founder-craft]
---
...
- `ins_housel-pretty-good-strategy-30-years`: a "pretty good" strategy maintained 30 years almost always beats a "brilliant" strategy maintained 5 years and abandoned.
- `ins_housel-reasonable-beats-rational`: people don't want the mathematically optimal strategy; they want one they can sleep with. Reasonable beats rational in practice.
- `ins_housel-doing-nothing-during-crisis`: willingness to do nothing during crisis is one of the most undervalued financial skills.
- `ins_getting-vs-staying-wealthy`: getting wealthy and staying wealthy require opposite skill sets; the second half is where most fortunes are lost.

**Naval Ravikant, the career corollary.**
- `ins_career-sequence-leverage-then-judgment`: spend the first half of your career acquiring leverage; spend the second half slowing down to apply judgment carefully.

**Nassim Taleb, the systemic frame.**
- `ins_taleb-via-negativa`: improvement comes more reliably from removing harm than adding good, sustainable subtraction beats brilliant addition.
- `ins_taleb-iatrogenics`: intervention in complex systems often causes more harm than the disease, inaction is frequently the higher-EV move.
- `ins_taleb-lindy-effect`: for non-perishable things, length-of-survival predicts remaining life-expectancy. The old framework that has survived has demonstrated sustainability.

**Charlie Munger, the discipline frame.**
- `ins_circle-of-competence`: knowing what you don't know beats being brilliant. Sustainable boundary-keeping compounds; brilliance applied outside the circle becomes confident error.
- `ins_mental-models-as-os-not-library`: mental models compound only when internalised over decades; later-career outperformance comes from accumulated wisdom, not from harder effort.

**Simon Sinek, the leadership frame.**
- `ins_sinek-infinite-game`: business is an infinite game played with finite-mindset rules. The mismatch is the source of strategic fragility. Sustainable infinite-mindset beats short-term-finite play.
...
- `pat_decision-quality-through-process-not-willpower`, the Kahneman + Munger pattern; sustainability is one of its corollaries.
