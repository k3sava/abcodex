...
convergence_count: 3
tier: A
uses_cards: [ins_taleb-via-negativa, ins_taleb-iatrogenics, ins_invert-always-invert, ins_circle-of-competence, ins_offer-and-market-as-highest-roi-lever]
domains: [strategy, product, leadership, founder-craft]
---
...
- **Nassim Taleb**, `ins_taleb-via-negativa`, `ins_taleb-iatrogenics`. Via negativa: improvement comes more reliably from removing harm than adding good. Iatrogenics: in poorly-understood complex systems, intervention often causes more harm than the disease.

- **Charlie Munger**, `ins_invert-always-invert`, `ins_circle-of-competence`. Inversion: ask "what would guarantee failure?" and avoid those conditions, rather than asking "how do I succeed?" Circle of competence: the discipline of refusing decisions outside the boundary, not expanding to take more.

- **Alex Hormozi**, `ins_offer-and-market-as-highest-roi-lever`. When growth stalls, fix the offer or change the market. The diagnostic order is *upstream first*, and the upstream fix is often subtractive (cut the wrong audience, cut weak components of the offer) rather than additive (more ad spend, more features, more channels).
...
See also `pat_decision-quality-through-process-not-willpower` for the broader Kahneman + Munger decision-quality pattern.
