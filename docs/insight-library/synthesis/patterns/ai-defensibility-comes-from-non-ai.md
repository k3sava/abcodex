...
convergence_count: 3
tier: A
uses_cards: [ins_intelligence-cost-converging-electricity, ins_altman-ai-not-a-business-exception, ins_altman-scarce-resources-abundant-intelligence, ins_specific-knowledge-cannot-be-mass-trained, ins_specific-knowledge-and-leverage, ins_circle-of-competence, ins_ramanujam-ai-pricing-against-labor-budgets]
domains: [ai-native, strategy, founder-craft, pmm]
---
...
- `ins_intelligence-cost-converging-electricity`: the cost of intelligence is converging toward the cost of electricity; durable advantage isn't using AI, it's parlaying AI.
- `ins_altman-ai-not-a-business-exception`: "we're using AI" is not a strategy; defensibility comes from domain expertise, customer relationships, and data.
- `ins_altman-scarce-resources-abundant-intelligence`: when intelligence is abundant, taste, judgment, relationships, and the ability to identify what is worth doing become the scarce resources.

**Naval Ravikant**, the wealth-philosophy view.
- `ins_specific-knowledge-cannot-be-mass-trained`: knowledge that society can mass-train will be commoditised; defensible careers and businesses are built on intersections that no single curriculum produces.
- `ins_specific-knowledge-and-leverage`: wealth = specific knowledge × leverage × judgment; only the first two compound; AI helps with leverage but not specific knowledge.

**Charlie Munger**, the cognitive view.
- `ins_circle-of-competence`: knowing what you don't know beats being brilliant; the operator's edge is the boundary of where their knowledge produces non-substitutable judgment.
...
Cards listed under uses_cards above. See also `pat_specific-knowledge-and-circle-of-competence` for the underlying non-substitutability pattern that this AI-era pattern extends.
