...
convergence_count: 3
tier: B
uses_cards: [ins_repair-as-primary-relationship-strategy, ins_most-generous-interpretation, ins_separate-behavior-from-identity, ins_criticize-in-public, ins_force-for-positive-momentum]
domains: [leadership, founder-operator]
---
...
## Operators
- Becky Kennedy, `ins_repair-as-primary-relationship-strategy`, `ins_most-generous-interpretation`, `ins_separate-behavior-from-identity`. The complete frame from parenting.
- Jeetu Patel (Cisco), `ins_criticize-in-public`. The exec ops corollary: build trust deep enough to critique in public, only possible when behavior is separated from identity.
- Claire Hughes Johnson, `ins_force-for-positive-momentum`. Be the force when the decider is unclear, applied generosity in motion.
