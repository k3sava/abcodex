...
uses_cards: [ins_jtbd-interviews-surface-customer-language, ins_no-decision-is-the-real-competitor, ins_nicolas-cole-voc-mirroring-beats-paraphrase, ins_market-to-product-product-to-market, ins_doshi-truth-one-level-down, ins_different-better-and-matters, ins_neumeier-onlyness-test, ins_trott-point-of-sameness, ins_trott-niche-at-scale, ins_worldview-led-marketing, ins_company-story-is-the-strategy, ins_b2b-buyer-emotion-personal-stakes, ins_homepage-five-second-trinity, ins_sameness-perception-is-the-differentiation-barrier, ins_test-positioning-in-live-sales-pitch, ins_sales-team-detects-positioning-failure-first, ins_judgment-doesnt-compress, ins_pierri-ai-positioning-needs-human-checkpoints]
uses_patterns: [pat_diagnose-before-execute, pat_buyer-mindset-not-product-features, pat_status-quo-is-the-competitor, pat_differentiation-vs-sameness, pat_narrative-as-strategy, pat_frontline-as-pmm-substrate, pat_execution-cheap-judgement-scarce, pat_verification-as-human-job]
uses_contradictions: [con_no-decision-vs-named-competitor]
originating_operators: [april-dunford, anthony-pierri, martina-lauchengco, ayo-omojola, bob-moesta, andy-raskin, marty-neumeier, seth-godin, dave-trott, shreyas-doshi, nicolas-cole, kevin-indig, dave-gerhardt, gartner]
---

# Build a positioning document from customer evidence to live validation

Positioning is a bet you commit to, not a thing you A/B test. You can test copy. You can test messaging angles. You cannot test who you are and who you're for. The document succeeds when the homepage hero, the sales deck's opening line, and a rep's first-call pitch all say the same thing without anyone copy-pasting between them.

Every downstream decision rests on the positioning you commit to: homepage, sales deck, campaign brief, onboarding sequence. Getting it right before you build all that is an order of magnitude cheaper than retrofitting it after. The cheap part now is producing the artifacts. The slow, load-bearing part is the judgment about which buyer, which alternative, which frame. `pat_execution-cheap-judgement-scarce`

This playbook is a 14-step pipeline from raw customer evidence to a published positioning document and live validation. It takes three to four weeks for a PMM with access to customers and the sales floor. Compress it and you skip the steps that produce the non-obvious insight. Stretch it and you're analyzing instead of acting.
...
### 1. Start with your best customers, not your largest.
...
After 5–10 interviews, highlight every phrase that appears across multiple buyers without being prompted. Those phrases are your message candidates. Keep them verbatim. Do not let an AI summarizer smooth them into clean themes, because the exact phrase is the hook and the clean theme is just a description. `ins_nicolas-cole-voc-mirroring-beats-paraphrase`
...
### 3. Map the full alternative set. Include doing nothing.
...
When 40-60% of buyers who passed on you made no decision at all, your real positioning problem is not "why us over them." It is "why do anything at all." `pat_status-quo-is-the-competitor`

The pitch must first establish that the cost of the status quo is real and specific. Only then does arguing why your solution is better than alternatives become useful. Skip this step and you build messaging that wins competitive head-to-head deals while losing to inertia at twice the rate. The remedy for a status-quo loss is narrative and problem framing. The remedy for a competitive loss is a comparison and a differentiator. Treating one as the other sends the work in the wrong direction. `con_no-decision-vs-named-competitor`
...
### 4. Build buyer personas from interview data, not from job titles.
...
> · Shreyas Doshi, Get to the Core of the Thing, 2026-05-16
...
### 5. Isolate unique attributes. Apply the three-check filter.

For each cluster of competitive alternatives from step 3, list every feature or capability that differentiates your product from that cluster. Stay at the capability level: what does the user actually do, not what the product technically has. `pat_buyer-mindset-not-product-features`
...
An attribute that passes checks 1 and 2 but not 3 is a feature, not a differentiator. Note it as a supporting proof point but do not lead with it. `pat_differentiation-vs-sameness`
...
### 6. Map attributes to value themes. Phrase them as user verbs.
...
### 7. Choose the market frame. This determines who the buyer compares you to.
...
> · Dave Trott, POINT-OF-SAMENESS, 2025-01-20
> `ins_trott-point-of-sameness`

> "The internet is Tokyo. The internet allows you to be niche at scale."
> · Dave Trott, POINT-OF-SAMENESS, 2025-01-20
> `ins_trott-niche-at-scale`
...
### 8. Write the unique belief. The worldview, not the value prop.
...
### 9. Run the Onlyness test before you trust the differentiation.

Before you commit the differentiation, stress-test it with one sentence: "Our brand is the only ___ that ___." The first blank is the category that uniquely identifies what you are. The second is the value that uniquely identifies what you do. If you cannot fill both with something genuinely different and genuinely valuable, the problem is not the wording. The problem is the business. `ins_neumeier-onlyness-test`
...
The same trinity governs the homepage hero you'll build in step 12: the specific use case, the alternative the buyer is using today, and the result, readable in roughly five seconds. `ins_homepage-five-second-trinity`
...
The sales team detects positioning failures months before any dashboard does. When reps say "I keep getting asked about X and I don't have a good answer" or "buyers keep saying we're just like Y," that is a positioning failure in real time. `pat_frontline-as-pmm-substrate`
...
A note on the AI you'll use across this pipeline. Models compress the production: drafting personas, clustering attributes, summarizing interviews. They do not compress the judgment about which buyer and which frame, and they will fabricate when you run them across multiple thin or contradictory inputs without a human checkpoint at each stage. `ins_judgment-doesnt-compress` `ins_pierri-ai-positioning-needs-human-checkpoints`
...
Keep a human verifying every generated claim against the source interview before it enters the document. `pat_verification-as-human-job`
...
- **Outcomes-led homepage.** "Build pipeline and close more revenue." Every sales tool says this. Lead with the capability, what someone actually does with the product. `pat_buyer-mindset-not-product-features`
- **Paraphrased buyer language.** A summarizer smooths the exact phrase into a clean theme and the copy stops resonating. Mirror the words; the phrase is the hook. `ins_nicolas-cole-voc-mirroring-beats-paraphrase`
- **Status-quo blindness.** Mapping competitors but not the status quo. When 40–60% of losses are to inertia, a purely competitive position misdirects most of the work. `pat_status-quo-is-the-competitor`
- **Differentiation that only lands internally.** Differentiators the team loves but buyers can't feel. Apply the three-check filter and test externally before launch. `pat_differentiation-vs-sameness`
- **Point-of-sameness positioning.** Optimizing for the broadest appeal so no buyer notices you. Take the specialist position; the niche is reachable at scale now. `ins_trott-point-of-sameness`
- **Wordsmithing a failed Onlyness test.** Re-running the sentence with the marketing team until copy passes without the strategy changing. The failure is in the business, not the wording. `ins_neumeier-onlyness-test`
- **Framework before customers.** Debating "platform vs. point solution" with no named customer on the table. Get three specific stories first; the truth is one level down. `ins_doshi-truth-one-level-down`
...
- **Positioning in a folder.** Completing the process but never installing it. When the homepage hero, the sales deck, and the rep's opening line diverge, you have a document, not a position. `pat_narrative-as-strategy`
- **Skipping the rep-input loop.** Treating the monthly narrative-drift audit as optional. Sales hears positioning failures in language first, months before dashboards. `pat_frontline-as-pmm-substrate`
- **Autonomous AI across thin inputs.** Running models on many contradictory inputs without a checkpoint per stage produces fabrication, not analysis. `ins_pierri-ai-positioning-needs-human-checkpoints`

## What you get

1. ICP snapshot: 5–10 best customers analyzed, commonalities documented.
2. JTBD interview transcripts: 5+ interviews with highlighted verbatim buyer language and switch triggers.
3. Competitive alternatives map: four clusters including status quo, with specific descriptions.
4. Champion profile: company type, persona, JTBD situation, and emotional stakes, not just a job title.
5. Value matrix per persona: Pain · Benefit · Capability · Message.
6. Onlyness statement: the only-that sentence, passed or escalated as a business question.
7. Positioning statement: one sentence, passes all four questions.
8. Messaging house: three pillars with feature-level evidence and customer quotes.
9. Homepage brief: eight-section structure with copy for each section.
10. Sales narrative brief: how the positioning statement maps to the discovery-to-close arc.
11. Collateral audit scorecard: existing materials checked against the positioning.
