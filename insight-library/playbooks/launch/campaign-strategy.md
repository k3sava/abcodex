...
uses_cards: [ins_earned-channels-over-algorithm-channels, ins_distribution-platform-cycles, ins_add-new-growth-model-every-18-months]
originating_operators: [emily-kramer, brian-balfour, elena-verna]
secondary_sources:
  - team-brain/workflows/campaign-gtm.md
  - team-brain/workflows/audience-bid-playbook.md
  - team-brain/workflows/demand-architecture.md
...
1. **Channel audit and selection.** Map existing channels by maturity stage. Evaluate new channels against PMM fit + GTM motion fit (`ins_earned-channels-over-algorithm-channels`).
