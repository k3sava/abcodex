...
Run the four phases on a quarterly cadence. Each phase has a deliverable; the Pricing Officer owns the gate between phases. Card: `ins_simon-formal-pricing-process`.
...
Cards: `ins_price-before-product`, `ins_ramanujam-three-wtp-questions`, `ins_ramanujam-feature-shock`, `ins_ramanujam-minivation`.
...
Cards: `ins_ltv-cac-ratio-and-cash-flow-trough`, `ins_skok-negative-churn`.
...
- **Premium tier (high-WTP segment).** High Dream Outcome × High Likelihood (proof + guarantees) / Low Time + Low Effort (DFY-heavy, see `ins_dfy-dwy-diy-delivery-stack`). Premium price. Premium pricing virtuous cycle compounds.
...
Cards: `ins_value-equation-grand-slam-offer`, `ins_premium-pricing-virtuous-cycle`.
...
Card: `ins_simon-discounting-most-dangerous-practice`.
...
Card: `ins_ramanujam-ai-pricing-against-labor-budgets`.
