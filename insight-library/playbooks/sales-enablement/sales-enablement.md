...
uses_cards: [ins_battle-cards-as-workflow-primitive, ins_sales-team-detects-positioning-failure-first, ins_test-positioning-in-live-sales-pitch, ins_company-story-is-the-strategy]
originating_operators: [april-dunford]
secondary_sources:
...
2. **Competitive intelligence.** Build/refresh battlecards for top 3–5 competitors. Use win/loss data, not assumptions (`ins_battle-cards-as-workflow-primitive`).
