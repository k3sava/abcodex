...
domain: [icp, jtbd, gtm]
uses_cards: [ins_jtbd-interviews-surface-customer-language, ins_marginal-user-methodology, ins_marketplace-liquidity-before-dynamics]
originating_operators: [bob-moesta]
secondary_sources:
  - team-brain/workflows/icp-definition.md
  - team-brain/workflows/vpc-methodology.md
