---
id: ins_utility-times-inspiration-times-empathy
...
source_type: book
source_title: "Ann Handley — Utility × Inspiration × Empathy framework"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [content, marketing]
lifecycle: [content, messaging-narrative]
...
## Conditions
Holds when:
- The team has the maturity to critique each axis independently.
- Editorial review can hold work back when one factor is missing.

Fails when:
- Pure performance / SEO content where the goal is keyword coverage and click-through, not relationship.
- Categories where one factor genuinely dominates buyer behavior (regulatory, technical reference).
