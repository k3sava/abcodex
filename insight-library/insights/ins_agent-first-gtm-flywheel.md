---
id: ins_agent-first-gtm-flywheel
operator: Yamini Rangan
operator_role: CEO, HubSpot
source_url: https://blog.hubspot.com/marketing/how-we-grow-with-agent-first-gtm
source_type: essay
source_title: How we Grow with Agent-first GTM
source_date: 2026-04-28
captured_date: 2026-05-01
domain: [gtm, ai-native, marketing]
...
tier: A
related: [ins_rebuild-gtm-around-ai, ins_agents-as-team-not-tools, ins_jtbd-as-agent-wiring-diagram]
raw_ref: raw/essays/yamini-rangan--agent-first-gtm-hubspot--2026-04.md
---

# Run agent-first GTM as a three-stage flywheel with one named agent per job
...
## Cross-references
- `ins_rebuild-gtm-around-ai` — Kieran Flanagan's complementary thesis: rebuild GTM around AI rather than bolt AI onto existing GTM.
- `ins_agents-as-team-not-tools` — Claire Vo's frame for why per-role agents beat single super-agents.
- `ins_jtbd-as-agent-wiring-diagram` — Evan Spiegel's principle of mapping agents 1:1 to jobs.
