---
id: ins_positioning-not-messaging-not-copy
operator: Aatir Abdul Rauf
operator_role: VP of Marketing, vFairs
source_url: https://www.linkedin.com/feed/update/urn:li:activity:7394355370770681856
source_type: thread
source_title: Positioning ≠ Messaging ≠ Copy
...
tier: B
related: [ins_positioning-is-a-business-identity-decision]
...
## Conditions
Holds when:
- The team has more than one channel/audience and needs message-to-copy fan-out.
- There is a CEO/revenue partner willing to ratify positioning calls.

Fails when:
- Single-channel, single-audience products where one tight piece of copy is the whole job.
- Pre-PMF where positioning shifts weekly and a heavy framework slows learning.
...
## Cross-references
- ins_positioning-is-a-business-identity-decision
