---
id: ins_roberge-technology-feedback-loop
...
source_type: book
source_title: "The Sales Acceleration Formula — The Technology Formula"
source_date: 2015-03-23
captured_date: 2026-05-05
domain: [sales-cs, ai-native, leadership]
lifecycle: [tech-stack, instrumentation, feedback-loops]
maturity: applied
artifact_class: framework
score: { originality: 3, specificity: 4, evidence: 4, transferability: 5, source: 5 }
tier: B
related: [ins_roberge-sales-as-engineering-discipline, ins_roberge-data-driven-coaching]
...
## Conditions
Holds when:
- The team has the analytical capability to act on the data, not just collect it.
- CRM and conversation-intelligence tools are adopted with high reliability (poor data quality breaks the loop).
...
- Training-curriculum changes track to specific data-driven insights about ramp curves and competency gaps.
