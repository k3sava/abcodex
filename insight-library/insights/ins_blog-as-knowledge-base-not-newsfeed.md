---
id: ins_blog-as-knowledge-base-not-newsfeed
operator: Andy Crestodina
...
lifecycle: [content, planning-resourcing]
maturity: applied
...
## Conditions
Holds when:
- The team has analytics granularity to identify high-converting URLs.
- Sales is willing to share recorded calls or summaries with content.

Fails when:
- News-driven categories where freshness *is* the value.
- Brand-led publishing where the goal is voice and frequency, not search authority.
...
- Pages have a "last updated" timestamp tied to actual maintenance, not a publish date.
