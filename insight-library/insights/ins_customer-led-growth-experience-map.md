---
id: ins_customer-led-growth-experience-map
operator: Georgiana Laudi
operator_role: Co-founder Forget the Funnel; ex-VP Marketing Unbounce
source_url: https://forgetthefunnel.com/
source_type: book
source_title: "Forget the Funnel — Customer Experience Map and CLG"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [growth, pmm, research-discovery]
lifecycle: [voc-research, onboarding-activation, retention]
maturity: applied
...
## Conditions
Holds when:
- The team has access to enough best-fit customers for JTBD research.
- Leadership accepts customer-outcome metrics replacing pipeline-stage metrics.

Fails when:
- Pre-PMF startups where best-fit customers haven't emerged yet.
- Multi-segment products where milestone definition diverges so wildly that a single map flattens reality.

## Evidence
> "Growth strategy should be built on customer success milestones, not business metrics; map the experience from problem awareness through expansion, measure what matters to customers, and the business metrics will follow."
