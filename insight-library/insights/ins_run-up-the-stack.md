---
id: ins_run-up-the-stack
operator: Packy McCormick
operator_role: Founder Not Boring; investor in Ramp, Scale AI, Replit, Varda
source_url: https://www.notboring.co/
source_type: essay
source_title: "Most Human Wins / Everything Is Technology"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [strategy, ai-native, founder-craft]
...
## Conditions
Holds when:
- The operator can identify what's just been commoditized and what's still scarce.
- The work tolerates rapid layering of new capabilities into existing offerings.

Fails when:
- Highly regulated categories where commoditized layers can't be freely combined.
- Categories where the "higher layer" doesn't exist meaningfully yet.

## Evidence
> "Everything is becoming technology, and the winners are those who 'run up the stack' — leveraging newly commoditized capabilities as inputs to create higher-order human value."
...
- Annual review identifies a new layer that just commoditized and how to use it.
