---
id: ins_add-new-growth-model-every-18-months
operator: Elena Verna
operator_role: Growth advisor; former Dropbox, Miro, Amplitude, SurveyMonkey
...
domain: [growth-demand]
lifecycle: [growth-loops, strategy-bets]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_earned-channels-over-algorithm-channels]
...
## Cross-references
- `ins_earned-channels-over-algorithm-channels` — the strategic frame inside which loop diversity matters
