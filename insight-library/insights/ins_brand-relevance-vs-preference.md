...
operator: David Aaker
operator_role: Professor Emeritus UC Berkeley Haas; Vice Chairman Prophet; "Father of Modern Branding"
source_url: https://prophet.com/
source_type: book
source_title: "Brand Relevance — making competitors irrelevant"
...
## Conditions
Holds when:
- There is real ideological or technological room to redefine the category.
...
- Marketing investment includes category-education content, not just product comparison.
- "Must-have" features are written down and the brand polices the boundary publicly.
