---
id: ins_sales-truth-stratified-not-bulk
operator: Anthony Pierri
operator_role: Co-founder, FletchPMM
source_url: https://www.earlynode.com/newsletters/the-7-step-framework-for-writing-killer-homepage-messaging-with-anthony-pierri
source_type: podcast
source_title: The 7-Step Framework for Writing Killer Homepage Messaging
source_date: 2026-04-22
captured_date: 2026-05-02
domain: [pmm, gtm, content]
lifecycle: [messaging-narrative, voc-research]
maturity: applied
...
Fails when: the call corpus is too sparse, or the human reviewer doesn't know the deals well enough to weight signals.
...
- Theme docs cite specific calls, not aggregated counts.
- Output ships in 1-2 days, not 1-2 weeks of theming.

## Counter-evidence
For early-stage products without deal flow, customer interviews substitute, but the same stratification (engaged vs. disengaged) applies.
