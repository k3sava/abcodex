---
id: ins_simon-discounting-most-dangerous-practice
...
source_type: book
source_title: "Confessions of the Pricing Man — Discounting"
...
tier: A
related: [ins_simon-pricing-is-structural-org-failure, ins_anchoring-pricing-negotiation, ins_one-percent-price-eight-percent-profit]
...
## Cross-references
- `ins_simon-pricing-is-structural-org-failure` — under-investment in pricing function is what allows discount habituation to grow unchecked.
- `ins_one-percent-price-eight-percent-profit` — the profit asymmetry that makes discount erosion so expensive.
- `ins_anchoring-pricing-negotiation` — Kahneman's anchoring is the cognitive mechanism behind reference-price reset.
