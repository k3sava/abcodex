---
id: ins_judgment-compounds-with-leverage
operator: Naval Ravikant
operator_role: Founder AngelList; investor; essayist on wealth, judgment, and leverage
source_url: https://nav.al/rich
source_type: essay
source_title: "How To Get Rich — Judgment as a Multiplier"
source_date: 2018-06-03
captured_date: 2026-05-05
domain: [strategy, founder-craft, leadership]
lifecycle: [strategy-bets, risk-quality, decision-quality]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_specific-knowledge-and-leverage, ins_code-and-media-permissionless-leverage, ins_circle-of-competence]
...
## Cross-references
- `ins_specific-knowledge-and-leverage`, judgment is the third term in Naval's wealth equation; this card focuses on its multiplicative effect.
- `ins_code-and-media-permissionless-leverage`, once code and media leverage is in place, judgment-quality becomes the binding constraint.
- `ins_circle-of-competence`, Munger's discipline of staying in-circle is a judgment-quality safeguard at high leverage.
