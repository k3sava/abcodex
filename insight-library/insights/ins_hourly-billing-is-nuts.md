---
id: ins_hourly-billing-is-nuts
operator: Jonathan Stark
operator_role: Pricing advisor; author Hourly Billing Is Nuts
source_url: https://jonathanstark.com/
source_type: book
source_title: "Hourly Billing Is Nuts — value pricing for solo consultants"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [sales, founder-craft, founder-operator]
lifecycle: [pricing-packaging, sales-enablement]
maturity: applied
...
## Conditions
Holds when:
- The consultant is a solo or very small operation with control over pricing model.
- Target clients can articulate the economic outcome they want.

Fails when:
- Industries where hourly billing is regulatory or cultural standard (legal, audit).
- Truly commoditized work where the buyer's benchmark is hourly rate from substitutes.

## Evidence
> "When you bill by the hour, your financial incentive is to work slowly and your client's incentive is to rush you. The better you get at your craft, the fewer hours you need, so expertise literally reduces your income."
...
- Proposals open with the Why Conversation summary, not a deliverables list.
- Pricing transition starts with a small project at a value-based fee, not an all-or-nothing flip.
