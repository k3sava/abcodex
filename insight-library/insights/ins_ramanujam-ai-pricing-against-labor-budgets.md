---
id: ins_ramanujam-ai-pricing-against-labor-budgets
...
source_type: essay
source_title: "Monetizing AI — Labor Budgets, Not IT Budgets"
source_date: 2024-09-01
captured_date: 2026-05-05
domain: [ai-native, pmm, gtm]
lifecycle: [pricing-packaging, monetisation, product-positioning]
maturity: frontier
artifact_class: framework
score: { originality: 5, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_simon-single-price-always-suboptimal, ins_intelligence-cost-converging-electricity, ins_value-equation-grand-slam-offer]
...
## Counter-evidence
The 25-50% capture rate assumes credible attribution and acknowledged labour substitution. Many AI products struggle to attribute value cleanly (the work would have happened anyway, the human was retained alongside the AI), and capture collapses to traditional SaaS rates. Sam Altman's `ins_intelligence-cost-converging-electricity` argues that the long-run trajectory is for intelligence cost to drop toward electricity cost — which would compress value-capture rates over time as the AI itself becomes commoditised.

## Cross-references
- `ins_intelligence-cost-converging-electricity` — Altman's frontier claim that complicates the long-run capture-rate trajectory.
- `ins_simon-single-price-always-suboptimal` — segment-by-WTP pricing applied to AI.
- `ins_value-equation-grand-slam-offer` — Hormozi's value equation; AI products score very high on the numerator (Dream Outcome × Likelihood) when they substitute labour.
