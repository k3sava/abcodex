---
id: ins_storybrand-customer-is-hero
operator: Donald Miller
operator_role: CEO StoryBrand / Business Made Simple; bestselling author
source_url: https://storybrand.com/
source_type: book
source_title: "Building a StoryBrand — 7-part BrandScript"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [pmm, marketing, content]
lifecycle: [messaging-narrative, positioning]
maturity: applied
...
## Conditions
Holds when:
- The business has never systematized messaging and needs a starting framework.
- The audience is mass-market enough that the universal story structure resonates.

Fails when:
- Sophisticated B2B buyers who detect formulaic story copy and discount it.
- Category-creation positioning where "Problem → Solution" doesn't capture the strategic move.
...
- One-liner in the format Problem → Solution → Result is used consistently across collateral.
