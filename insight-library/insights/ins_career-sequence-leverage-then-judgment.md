---
id: ins_career-sequence-leverage-then-judgment
...
source_type: essay
source_title: "How To Get Rich — Career Sequencing"
source_date: 2018-06-03
captured_date: 2026-05-05
domain: [founder-craft, leadership, strategy]
lifecycle: [career-arc, strategy-bets]
maturity: applied
artifact_class: playbook
score: { originality: 4, specificity: 4, evidence: 4, transferability: 4, source: 5 }
tier: B
related: [ins_judgment-compounds-with-leverage, ins_code-and-media-permissionless-leverage]
...
## Conditions
Holds when:
- Career trajectory is on a leverage-accumulation path (founder, investor, creator, executive). For non-leverage paths the framing is less binding.
- The operator can recognise their own mode-shift moment; this requires honest self-assessment of accumulated leverage.
...
- Time-to-decision metrics: for the same class of decision, deliberation time increases over career stage.
