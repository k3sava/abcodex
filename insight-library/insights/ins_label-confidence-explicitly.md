...
domain: [leadership, product, founder-operator]
lifecycle: [process-cadence]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 3, transferability: 5, source: 5 }
tier: A
related: [ins_make-intuition-explicit, ins_force-for-positive-momentum]
raw_ref: raw/podcasts/mihika-kapoor--zero-to-one-vision-conviction-hype--2026-04-28.md
---

# Label every strong opinion with a confidence level so the room knows when to push back
...
- `ins_force-for-positive-momentum`, what to do once the labels are clear
