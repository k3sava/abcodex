...
## Conditions
Holds when:
- The negotiation has stakes that justify the research time (senior hires, consulting contracts, partnerships).
- You have or can build access to peers and advisors with relevant intel.

Fails when:
- The negotiation is small enough that research time exceeds expected upside.
- The buyer is genuinely open and the asymmetry isn't being exploited. Over-investing in defense produces over-prepared paranoia.
...
- Procedural traps (split-the-difference, anchor-with-wrong-number) get caught and reframed.
- The buyer's first response indicates surprise at how prepared you are.
