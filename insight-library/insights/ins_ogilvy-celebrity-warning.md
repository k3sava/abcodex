---
id: ins_ogilvy-celebrity-warning
...
source_type: book
source_title: "Ogilvy on Advertising — Celebrity Endorsements"
source_date: 1983-01-01
captured_date: 2026-05-05
domain: [pmm, marketing, design]
lifecycle: [creative-direction, brand-strategy]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 4, evidence: 4, transferability: 4, source: 5 }
tier: B
related: [ins_ogilvy-we-sell-or-else, ins_ogilvy-consumer-is-your-wife]
...
## Cross-references
- `ins_ogilvy-we-sell-or-else` — Ogilvy's foundational claim; celebrity that doesn't sell the product is creative theatre, not advertising.
- `ins_ogilvy-consumer-is-your-wife` — adjacent claim; celebrity-without-fit assumes the consumer is fooled by fame, which she is not.
