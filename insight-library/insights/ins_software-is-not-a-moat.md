...
## Mechanism
Software is reproducible at near-zero cost; the marginal cost of copying a feature is engineering time. Once a feature works, multiple competitors ship it within weeks. Ecosystems and hardware have switching costs and network effects that engineering time cannot replicate. Distribution requires channel relationships, brand trust, and platform leverage that compound over years. The moat is whatever the next competitor can't copy in a quarter.

## Conditions
Holds when:
- The category has clear copy-paste mechanics (mobile apps, SaaS UI, prompts).
...
- Competitors copy your features quickly without making a dent in your share.
