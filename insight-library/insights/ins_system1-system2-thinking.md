---
id: ins_system1-system2-thinking
operator: Daniel Kahneman
operator_role: Nobel laureate; Princeton emeritus; co-founder of behavioral economics
source_url: https://en.wikipedia.org/wiki/Daniel_Kahneman
source_type: book
source_title: "Thinking, Fast and Slow — System 1 and System 2"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [strategy, leadership, research-discovery]
...
## Conditions
Holds when:
- Decisions are infrequent and high-stakes enough to justify process overhead.
- Team can hold itself to the discipline (independent estimates before group discussion, etc.).

Fails when:
- High-frequency tactical decisions where System 1 speed matters more than accuracy.
- Domains where the relevant pattern recognition is genuinely earned expertise (chess masters, ER doctors).
