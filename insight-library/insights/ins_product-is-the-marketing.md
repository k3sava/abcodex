---
id: ins_product-is-the-marketing
operator: Seth Godin
...
source_type: book
source_title: "Purple Cow: Transform Your Business by Being Remarkable"
source_date: 2003-05-08
captured_date: 2026-05-05
domain: [product, design, pmm, growth-demand]
lifecycle: [productisation, positioning, distribution]
maturity: foundational
artifact_class: framework
score: { originality: 5, specificity: 4, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_smallest-viable-audience, ins_worldview-led-marketing]
...
## Cross-references
- `ins_smallest-viable-audience` — remarkable products land hardest on a tightly defined audience that *will* talk about them.
- `ins_worldview-led-marketing` — what counts as "remarkable" is determined by the audience's worldview, not the marketer's taste.
