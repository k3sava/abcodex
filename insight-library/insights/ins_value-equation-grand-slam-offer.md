---
id: ins_value-equation-grand-slam-offer
operator: Alex Hormozi
operator_role: Co-founder Acquisition.com; author of $100M Offers and $100M Leads
source_url: https://www.acquisition.com/
source_type: book
source_title: "$100M Offers — Grand Slam Offer methodology"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [marketing, sales, growth-demand]
lifecycle: [pricing-packaging, messaging-narrative]
maturity: applied
...
## Conditions
Holds when:
- The customer can articulate a measurable dream outcome.
- The seller can credibly affect time-delay or effort (services, education, productized SaaS).

Fails when:
- Pure commodity products with no differentiable dream outcome.
- Markets where buying decisions are dominated by procurement/RFP rituals, not value perception.
...
- Offers stack named solutions for each obstacle, not a feature list.
