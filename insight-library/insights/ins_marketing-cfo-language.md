---
id: ins_marketing-cfo-language
operator: Rowan Tonkin
operator_role: CMO Planful; pioneer of CMO-CFO alignment methodology
source_url: https://planful.com/
source_type: podcast
source_title: "Rowan Tonkin — synergy between finance and marketing"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [marketing-ops, leadership, gtm]
lifecycle: [attribution-measurement, planning-resourcing]
maturity: applied
...
## Conditions
Holds when:
- The org has finance maturity to actually consume marketing-financial dashboards.
- The CMO has the data literacy to do the translation credibly.

Fails when:
- Pre-revenue startups where marketing-to-finance translation isn't yet meaningful.
- Pure-brand investments where the financial translation flattens what's actually working.
...
- CMO-CFO joint review is a standing meeting, not an escalation.
