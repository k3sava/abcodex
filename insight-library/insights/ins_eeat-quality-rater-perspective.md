---
id: ins_eeat-quality-rater-perspective
operator: Cyrus Shepard
operator_role: Founder Zyppy SEO; ex-Chief SEO Strategist Moz; former Google Search Quality Rater
source_url: https://zyppy.com/
source_type: essay
source_title: "I secretly worked as a Google Search Quality Rater — Zyppy SEO"
...
## Conditions
Holds when:
- Site is in YMYL or expertise-sensitive categories where rater scrutiny is highest.
- Content can credibly be attributed to specific authors with real credentials.

Fails when:
- Pure-aggregator or programmatic-content sites where author attribution feels manufactured.
- Brand-led sites where the brand's reputation already supplies the trust signal.
...
- Articles cite primary sources inline, not just secondary aggregators.
