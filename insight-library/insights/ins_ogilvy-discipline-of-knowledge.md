---
id: ins_ogilvy-discipline-of-knowledge
operator: David Ogilvy
operator_role: Founder Ogilvy & Mather; "Father of Advertising"
source_url: https://en.wikipedia.org/wiki/David_Ogilvy_(businessman)
source_type: book
source_title: "Ogilvy on Advertising — Research as Discipline"
source_date: 1983-01-01
captured_date: 2026-05-05
domain: [pmm, marketing, research-discovery, design]
lifecycle: [research-discovery, brand-strategy, creative-direction]
maturity: foundational
artifact_class: framework
score: { originality: 5, specificity: 4, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_ramanujam-three-wtp-questions, ins_jtbd-interviews-surface-customer-language, ins_ogilvy-we-sell-or-else]
...
## Cross-references
- `ins_ramanujam-three-wtp-questions` — Ramanujam's adjacent claim: WTP research before product / pricing decisions.
- `ins_jtbd-interviews-surface-customer-language` — Moesta's adjacent claim: switch interviews as the canonical research method for buyer language.
- `ins_ogilvy-we-sell-or-else` — Ogilvy's foundational claim; research is what makes selling-discipline work.
