---
id: ins_code-and-media-permissionless-leverage
...
source_type: essay
source_title: "How To Get Rich — Permissionless Leverage"
source_date: 2018-06-03
captured_date: 2026-05-05
domain: [founder-craft, growth-demand, engineering, product]
lifecycle: [productisation, distribution, content-strategy]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_specific-knowledge-and-leverage, ins_specific-knowledge-cannot-be-mass-trained]
...
## Cross-references
- `ins_specific-knowledge-and-leverage`, leverage is one of the three multipliers in Naval's wealth equation.
- `ins_llm-wiki-pattern`, Karpathy's wiki pattern is itself an artefact of the code-and-media leverage class (a structured asset that pays back over time).
