---
id: ins_loss-aversion-status-quo-bias
...
source_type: book
source_title: "Thinking, Fast and Slow — Loss Aversion"
source_date: 2011-10-25
captured_date: 2026-05-05
domain: [product, gtm, pmm]
lifecycle: [positioning, messaging-narrative, pricing-packaging]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_system1-system2-thinking, ins_no-decision-is-the-real-competitor]
...
## Cross-references
- `ins_system1-system2-thinking` — loss aversion is one of the System-1 biases that requires structured process to override.
- `ins_no-decision-is-the-real-competitor` — April Dunford's adjacent claim that the status quo, not competitors, is what kills B2B deals.
