---
id: ins_anchor-high-pricing
operator: Blair Enns
operator_role: Founder Win Without Pitching; author The Win Without Pitching Manifesto
source_url: https://www.winwithoutpitching.com/
source_type: book
source_title: "Anchor High — pricing the client, not the service"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [sales, founder-craft]
...
## Conditions
Holds when:
- The seller can credibly run a value conversation (services, consulting, expertise work).
- The buyer is senior enough to authorize value-based pricing.

Fails when:
- Procurement-led purchases where the buyer is forbidden from anchoring on value.
- Highly commodified categories where market price is fully transparent.
...
- Sellers can quote ranges in the value conversation before any proposal is written.
- Identical scope is priced differently for different clients without internal discomfort.
