---
id: ins_pmm-stakeholder-crm
operator: Shireesh Gupta
operator_role: Product Marketing Manager
source_url: https://www.linkedin.com/in/shireeshgupta/
source_type: thread
source_title: "Stakeholder management system in Claude Code"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [pmm, ai-native]
lifecycle: [ownership-org, ai-workflow]
maturity: applied
...
## Conditions
Holds when:
- The PMM operates across enough stakeholders that relationship rot is a real risk.
- The org has Claude Code or equivalent AI substrate available.

Fails when:
- Solo founders or tiny teams where stakeholder count is small enough to remember.
- Highly transactional roles where relationship depth isn't a job requirement.
...
- Weekly review surfaces relationships at risk, not just deliverables shipped.
- Time-allocation reports include the 35% stakeholder line, not just project hours.
