---
id: ins_altman-ai-not-a-business-exception
operator: Sam Altman
...
source_type: essay
source_title: "Startup Playbook — AI Companies Aren't Exempt"
source_date: 2015-09-08
captured_date: 2026-05-05
domain: [strategy, gtm, ai-native]
lifecycle: [strategy-bets, fundraising, positioning]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_intelligence-cost-converging-electricity, ins_altman-singularity-as-smooth-curve, ins_thiel-poor-sales-not-bad-product]
...
## Cross-references
- `ins_intelligence-cost-converging-electricity`, the long-run trajectory that makes AI-as-moat fail.
- `ins_thiel-poor-sales-not-bad-product`, Thiel's adjacent claim: distribution beats product, even AI product.
- `ins_specific-knowledge-cannot-be-mass-trained`, Naval's claim on what's actually defensible.
