---
id: ins_use-case-epiphany-as-marketing-job
operator: Krithika Shankarraman
operator_role: EIR, Thrive Capital; ex-VP Marketing OpenAI; first marketer at Stripe and Retool
...
lifecycle: [messaging-narrative, onboarding-activation]
maturity: applied
artifact_class: framework
score: { originality: 5, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_date-diagnostic-framework, ins_comb-shape-pmm]
...
## Cross-references
- `ins_date-diagnostic-framework` — the diagnostic that decides whether use-case epiphany is the actual problem
- `ins_comb-shape-pmm` — the team shape needed to produce epiphanies across formats
