---
id: ins_icp-account-not-persona
operator: TK Kader
operator_role: Founder TK Kader's AI/SaaS GTM Program
source_url: https://idealcustomerprofile.com/
source_type: essay
source_title: "Ideal Customer Profile — TK Kader template + framework"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [pmm, gtm, sales]
lifecycle: [planning-resourcing, positioning]
maturity: applied
...
## Conditions
Holds when:
- The team has authority and discipline to enforce ICP-only across functions.
- The category genuinely has a definable ICP (some markets have multiple equally-valuable segments).

Fails when:
- Pre-PMF startups still discovering which ICP works.
- Multi-product companies whose various lines have legitimately different ICPs.
...
- Pipeline reviews open with ICP-fit distribution before tactical deal updates.
- Product roadmap explicitly prioritizes ICP-segment asks; non-ICP requests are tracked separately.
