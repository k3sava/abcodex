---
id: ins_story-driven-vs-competition-driven
operator: Bernadette Jiwa
operator_role: Brand storyteller; author Story Driven
source_url: https://thestoryoftelling.com/
source_type: book
source_title: "Story Driven — backstory, vision, purpose, values, strategy"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [strategy, pmm, marketing]
...
## Conditions
Holds when:
- The founders are willing to lose customers who don't share their values.
- The category has enough room for differentiated stories (most do).

Fails when:
- Hyper-fragmented utility categories where buyers explicitly comparison-shop on spec.
- Companies whose actual purpose is acquisition arbitrage rather than long-term operation.
...
- The team can name customers it has turned away on values grounds.
