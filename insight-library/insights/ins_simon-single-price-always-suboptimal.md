---
id: ins_simon-single-price-always-suboptimal
...
source_type: book
source_title: "Confessions of the Pricing Man — Price Differentiation"
source_date: 2015-10-23
captured_date: 2026-05-05
domain: [pmm, growth-demand, gtm]
lifecycle: [pricing-packaging, segmentation, monetisation]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_simon-pricing-is-structural-org-failure, ins_value-equation-grand-slam-offer]
...
## Cross-references
- `ins_simon-pricing-is-structural-org-failure`, without a pricing function, segment-by-segment price differentiation rarely gets built.
- `ins_value-equation-grand-slam-offer`, Hormozi's framework for building each tier of the differentiated structure.
- `ins_dfy-dwy-diy-delivery-stack`, Hormozi's tiering approach: DFY for high-WTP, DIY for low-WTP.
