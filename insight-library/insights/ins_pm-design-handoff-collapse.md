...
operator_role: Product growth advisor, News from Aakash
...
domain: [product, ai-native, design-ux]
lifecycle: [ai-workflow, ownership-org]
maturity: frontier
...
- Design reviews open with critique of an existing prototype rather than briefing a new one.
- Design lead reviews the visual system before any user sees the prototype.
