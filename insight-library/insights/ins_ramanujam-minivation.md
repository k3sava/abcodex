...
source_type: book
source_title: "Monetizing Innovation — Minivation"
source_date: 2016-05-02
captured_date: 2026-05-05
domain: [pmm, strategy, growth-demand]
lifecycle: [pricing-packaging, monetisation]
maturity: applied
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_ramanujam-feature-shock, ins_ramanujam-hidden-gems, ins_simon-single-price-always-suboptimal]
...
## Cross-references
- `ins_ramanujam-feature-shock`, `ins_ramanujam-hidden-gems` — the other two Ramanujam failure modes.
- `ins_simon-single-price-always-suboptimal` — Hermann Simon's underlying principle on WTP heterogeneity.
- `ins_anchoring-pricing-negotiation` — the cognitive mechanism that makes Minivation hard to recover from.
