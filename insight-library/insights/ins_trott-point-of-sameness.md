---
id: ins_trott-point-of-sameness
operator: Dave Trott
...
source_type: essay
source_title: "POINT-OF-SAMENESS"
source_date: 2025-01-20
captured_date: 2026-05-05
domain: [pmm, marketing, design, strategy]
lifecycle: [positioning, creative-direction, brand-strategy]
maturity: foundational
artifact_class: framework
score: { originality: 5, specificity: 5, evidence: 4, transferability: 5, source: 5 }
tier: A
related: [ins_neumeier-onlyness-test, ins_no-decision-is-the-real-competitor, ins_trott-change-the-game]
...
## Cross-references
- `ins_neumeier-onlyness-test` — Neumeier's adjacent claim; Onlyness is the substantive form of point-of-difference.
- `ins_no-decision-is-the-real-competitor` — Dunford's adjacent claim; point-of-sameness produces no-decision because the buyer has no reason to choose any brand.
- `ins_trott-change-the-game` — game-changing is one structural way to escape point-of-sameness.
