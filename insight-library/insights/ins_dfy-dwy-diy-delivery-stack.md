---
id: ins_dfy-dwy-diy-delivery-stack
...
source_type: book
source_title: "$100M Offers — Delivery Vehicles"
source_date: 2021-07-13
captured_date: 2026-05-05
domain: [product, sales-cs, pmm]
lifecycle: [pricing-packaging, productisation, services-design]
maturity: applied
...
## Cross-references
- `ins_value-equation-grand-slam-offer`, DFY/DWY/DIY is one expression of pulling the Value Equation's "effort & sacrifice" denominator down for the buyer while preserving margin.
- `ins_specific-knowledge-and-leverage`, Naval's leverage map: DFY is labour leverage, DWY/DIY is product (zero-marginal-cost) leverage stacked on top.
