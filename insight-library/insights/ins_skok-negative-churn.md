...
source_type: essay
source_title: "SaaS Metrics 2.0 — Negative Churn"
source_date: 2015-09-01
captured_date: 2026-05-05
domain: [growth-demand, strategy, pmm]
lifecycle: [retention-expansion, pricing-packaging, customer-success]
maturity: foundational
artifact_class: framework
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_skok-churn-reduction-doubles-ltv, ins_ltv-cac-ratio-and-cash-flow-trough]
...
## Cross-references
- `ins_skok-churn-reduction-doubles-ltv` — necessary precondition: cut gross churn before negative net churn is reachable.
- `ins_ltv-cac-ratio-and-cash-flow-trough` — Skok's foundational unit economics frame.
- `ins_premium-pricing-virtuous-cycle` — Hormozi's adjacent claim: better customers produce more expansion-friendly behaviour.
