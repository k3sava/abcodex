---
id: ins_messaging-equation-personalization-tiers
operator: John Barrows
operator_role: Founder JB Sales; trains Salesforce, LinkedIn, Dropbox, Slack
source_url: https://www.jbarrows.com/
source_type: essay
source_title: "John Barrows — Messaging Equation and personalization tiers"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [sales, gtm]
lifecycle: [outbound, sales-enablement]
maturity: applied
...
## Conditions
Holds when:
- Sales team has tooling to ingest trigger events at scale (LinkedIn alerts, Crunchbase, intent data).
- Tier targets exist: 50-100 named accounts for Tailored, hundreds for Targeted, thousands for Templated.

Fails when:
- The category has no observable trigger events (steady-state replacement-cycle products).
- Outbound is the only channel and over-personalization compensates for weak product positioning.
...
- Trigger-event ingestion is automated; reps don't manually scan LinkedIn for news.
