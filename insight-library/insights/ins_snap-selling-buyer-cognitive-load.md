---
id: ins_snap-selling-buyer-cognitive-load
operator: Jill Konrath
operator_role: Author SNAP Selling, Selling to Big Companies, Agile Selling
source_url: https://www.jillkonrath.com/
source_type: book
source_title: "SNAP Selling — buyer cognitive load and three sequential decisions"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [sales, gtm]
lifecycle: [sales-enablement, outbound]
maturity: applied
...
## Conditions
Holds when:
- Buyers are senior enough that cognitive overload is a real constraint.
- Sales process can be redesigned around buyer decisions, not seller stages.

Fails when:
- Highly transactional sales where the buyer's "decision" is one click.
- Cultures where technique-driven cognitive-load reduction reads as evasive.
...
- CRM stages map to the three buyer decisions, not seller activities.
- Pre-engagement research follows a Buyer's Matrix template, not freeform notes.
