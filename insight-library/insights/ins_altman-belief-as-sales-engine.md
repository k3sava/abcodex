---
id: ins_altman-belief-as-sales-engine
operator: Sam Altman
...
source_type: essay
source_title: "Startup Playbook — Sales by Belief"
source_date: 2015-09-08
captured_date: 2026-05-05
domain: [sales-cs, founder-craft, gtm]
lifecycle: [founder-led-selling, sales-enablement]
maturity: applied
artifact_class: framework
score: { originality: 3, specificity: 4, evidence: 3, transferability: 4, source: 5 }
tier: B
related: [ins_voss-tactical-empathy-labels, ins_thiel-poor-sales-not-bad-product]
...
## Cross-references
- `ins_voss-tactical-empathy-labels` — listening discipline that complements belief-driven selling.
- `ins_thiel-poor-sales-not-bad-product` — Thiel's adjacent claim that distribution / sales failure is the most common failure mode; belief is one component of why.
