---
id: ins_creative-is-the-spike
operator: Andrew Faris
operator_role: Founder AJF Growth (ecommerce growth consultancy)
source_url: https://ajfgrowth.com/
source_type: essay
source_title: "How to scale from $1M to $20M with Andrew Faris"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [growth-demand, marketing]
lifecycle: [planning-resourcing, content]
maturity: applied
...
## Conditions
Holds when:
- Brand is past initial PMF and is ready to spend serious paid media.
...
- Brand has named winning creative *concepts* (not just winning ads) and a queue of variations against each.
- A creative-ops manager owns throughput targets independent of the media buyer.
