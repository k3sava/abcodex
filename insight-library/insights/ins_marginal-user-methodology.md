...
domain: [growth-demand, product, research-discovery]
lifecycle: [growth-loops, onboarding-activation]
maturity: foundational
artifact_class: playbook
score: { originality: 4, specificity: 5, evidence: 5, transferability: 5, source: 5 }
tier: A
related: [ins_understand-then-identify-then-execute, ins_lead-bullets-and-cannonballs]
