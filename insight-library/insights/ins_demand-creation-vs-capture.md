---
id: ins_demand-creation-vs-capture
operator: Chris Walker
operator_role: Founder & CEO Passetto; Chairman Refine Labs
source_url: https://www.refinelabs.com/
source_type: podcast
source_title: "State of Demand Gen — demand creation vs. capture"
source_date: 2026-03-03
captured_date: 2026-05-02
domain: [growth-demand, gtm, marketing]
...
## Conditions
Holds when:
- The category has a meaningful "out-of-market" buyer base that can be educated.
- Leadership is willing to fund channels that won't show up in last-click attribution.

Fails when:
- Highly transactional categories where every buyer is in-market every quarter.
- Pre-PMF startups that need any deal closing now and can't fund 12-month brand investment.
...
- Customer-reported "How did you hear about us?" runs alongside software attribution.
