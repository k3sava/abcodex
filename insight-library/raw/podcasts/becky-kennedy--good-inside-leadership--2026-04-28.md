---
title: Dr. Becky Kennedy — Good Inside leadership, repair, MGI, behavior vs identity
type: raw
source: Lenny's Podcast (Dropbox archive)
guest: Dr. Becky Kennedy (clinical psychologist; founder, Good Inside)
...
- **Behavior is communication of an unmet need or missing skill.** "When you look at bad behavior, the actual problem is someone doesn't have the skill they need to manage something happening internally." Counter to the "they're being difficult" frame — the right question is what skill is missing.
- **Allergy to ideas without action.** Becky herself only commits to frameworks that have a concrete script. Mirrors flywheel discipline — every concept paired with a usable artifact or phrase.
- **Defensiveness signal: someone thinks identity is being discussed.** When a teammate gets defensive, it's almost never about the behavior on the table — they think their identity is on trial. The repair move is to explicitly take identity off the table: "I'm not questioning whether you're [smart/serious/committed], I'm naming a specific thing that needs to change."
...
- [feedback_captain_rotation.md] — sturdy + repair complement criticize-in-public
- [feedback_kill_pod.md] — language shapes thought; the team's operating norm starts with what we call ourselves
- [raw/podcasts/lenny/2026-04-28-jeetu-patel-cisco-ai-first-transformation.md] — culture as norms-around-action; Becky's behavior-vs-identity is the micro-version of the same idea
- [raw/podcasts/lenny/2026-04-28-jessica-fain-influencing-executives.md] — discovery-not-conviction lens pairs with MGI
