...
convergence_count: 6
tier: A
uses_cards: [ins_zero-to-one-monopoly, ins_thiel-competition-destroys-profits, ins_thiel-vertical-vs-horizontal-progress, ins_specific-knowledge-cannot-be-mass-trained, ins_specific-knowledge-and-leverage, ins_circle-of-competence, ins_neumeier-onlyness-test, ins_starving-crowd-beats-offer, ins_no-decision-is-the-real-competitor]
domains: [strategy, founder-craft, pmm, gtm]
---
...
- **Peter Thiel**, `ins_zero-to-one-monopoly`, `ins_thiel-competition-destroys-profits`, `ins_thiel-vertical-vs-horizontal-progress`. Competition is for losers; competitive markets destroy profits; the value lives in 0-to-1 vertical progress that creates monopoly conditions.
- **Naval Ravikant**, `ins_specific-knowledge-and-leverage`, `ins_specific-knowledge-cannot-be-mass-trained`. Defensible careers and businesses are built on specific knowledge that cannot be mass-trained, the labour-market equivalent of monopoly.
- **Charlie Munger**, `ins_circle-of-competence`. Knowing what you don't know beats being brilliant; the boundary is what makes the operator non-substitutable inside it.
- **Marty Neumeier**, `ins_neumeier-onlyness-test`. The Onlyness statement ("the only X that does Y") is a company-viability test for differentiation, fail it and the problem is the company, not the messaging.
- **Alex Hormozi**, `ins_starving-crowd-beats-offer`. Market choice (Starving Crowd) outranks offer strength, which outranks persuasion; pick a hungry market with weak alternatives, not a crowded one.
- **April Dunford**, `ins_no-decision-is-the-real-competitor`. B2B positioning is built around competitive alternatives + uniquely valuable capabilities; if the buyer can substitute another vendor at lower cost, the position has no defensibility.
