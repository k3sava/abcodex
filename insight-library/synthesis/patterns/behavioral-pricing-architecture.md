...
convergence_count: 5
tier: A
uses_cards: [ins_ariely-relativity-principle, ins_ariely-arbitrary-coherence, ins_ariely-power-of-free, ins_ariely-pain-of-paying-modulators, ins_ariely-pennies-a-day-effect, ins_decoy-effect-pricing, ins_pain-of-paying, ins_anchoring-pricing-negotiation, ins_loss-aversion-status-quo-bias, ins_simon-single-price-always-suboptimal, ins_simon-discounting-most-dangerous-practice, ins_value-equation-grand-slam-offer, ins_dfy-dwy-diy-delivery-stack, ins_ramanujam-three-wtp-questions, ins_ramanujam-leaders-fillers-killers]
domains: [pmm, gtm, growth-demand, design, product]
---
...
- `ins_ariely-relativity-principle`: humans cannot evaluate prices in isolation, only by comparison.
- `ins_ariely-arbitrary-coherence`: once an initial price is set, the entire category is anchored to it.
- `ins_ariely-power-of-free`: the gap between $0.01 and $0.00 is psychologically larger than any other 1-cent gap.
- `ins_ariely-pain-of-paying-modulators`: pain varies with method, timing, and granularity.
- `ins_ariely-pennies-a-day-effect`: framing annual price as daily trivializes the cost.
- `ins_decoy-effect-pricing`, `ins_pain-of-paying`: the foundational claims.

**Daniel Kahneman, the decision-quality substrate.**
- `ins_anchoring-pricing-negotiation`: the first number sets the range.
- `ins_loss-aversion-status-quo-bias`: losses feel ~2× as painful as equivalent gains.

**Hermann Simon, the org-level discipline.**
- `ins_simon-single-price-always-suboptimal`: WTP heterogeneity makes single-price strategies always suboptimal.
- `ins_simon-discounting-most-dangerous-practice`: discounting damages the entire architecture; reference prices reset permanently.

**Madhavan Ramanujam, the research method.**
- `ins_ramanujam-three-wtp-questions`: three questions + "Why?" surface psychological price thresholds and demand cliffs.
- `ins_ramanujam-leaders-fillers-killers`: bundle features by Leaders/Fillers/Killers per segment.

**Alex Hormozi, the offer-construction layer.**
- `ins_value-equation-grand-slam-offer`: Value = (Dream Outcome × Likelihood) / (Time × Effort).
- `ins_dfy-dwy-diy-delivery-stack`: tier the offer by who does what.
...
Cards listed under uses_cards above. See also `pat_pricing-as-the-most-leveraged-org-failure` for the org-level companion pattern.
