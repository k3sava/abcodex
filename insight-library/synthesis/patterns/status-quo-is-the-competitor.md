---
id: pat_status-quo-is-the-competitor
title: Status quo / no-decision is the real competitor
captured_date: 2026-05-01
last_updated: 2026-05-05
convergence_count: 6
tier: A
uses_cards: [ins_no-decision-is-the-real-competitor, ins_old-game-to-new-game-narrative, ins_homepage-five-second-trinity, ins_use-case-epiphany-as-marketing-job, ins_obstacles-as-gates-not-problems, ins_setup-follow-through-pitch, ins_loss-aversion-status-quo-bias, ins_jtbd-interviews-surface-customer-language]
domains: [pmm, gtm, product, sales-cs]
---
...
- **April Dunford** — `ins_no-decision-is-the-real-competitor` and `ins_setup-follow-through-pitch`. 40-60% of B2B buyers say "no decision"; the pitch must run a Setup before the Follow-Through.
- **Andy Raskin** — `ins_old-game-to-new-game-narrative` and `ins_obstacles-as-gates-not-problems`. Sell the world-shift, not the product comparison; frame features as obstacles to a *new* game, not problems on the current one.
- **Anthony Pierri** — `ins_homepage-five-second-trinity`. The B2B homepage must communicate use case, alternative, and result in five seconds — without naming the alternative, the buyer does not know what game you're playing.
- **Krithika Shankarraman** — `ins_use-case-epiphany-as-marketing-job`. Once awareness is solved, marketing's real job is the use-case epiphany — make the buyer realise the problem is real and worth doing now.

**Cognitive mechanism (why the asymmetry exists):**

- **Daniel Kahneman** — `ins_loss-aversion-status-quo-bias`. The asymmetric value function: losses register at roughly 2× the weight of equivalent gains. Switching products requires the buyer to first concede a felt loss before banking the gain. A 1.2-1.5× value lift cannot clear loss aversion's 2× tax. *Provides the mechanism behind why the status quo wins by default.*

**Research method (how to surface buyer-side resistance):**

- **Bob Moesta** — `ins_jtbd-interviews-surface-customer-language`. JTBD's "forces of progress" framework: every purchase decision is governed by forces of progress (push of the situation, pull of the new solution) competing against forces of resistance (anxiety about the new, allegiance to the existing). Switch interviews surface buyer language *for and against*; resistance language is more diagnostic than progress language. *Provides the method to extract the buyer's actual inertia language for use in pitch and copy.*
