...
slug: mustafa-ali
roles:
  - Mobile engineer, Shopify
domains_active: [engineering-ai-eng, ios-app-craft, ai-native]
captured_first: 2026-09-11
external:
...
- **Agent-driven engineering economics.** His work surfaces how coding agent capabilities shift the human cost of maintaining multiple platform codebases, reducing the cross-platform advantage to zero or negative.
