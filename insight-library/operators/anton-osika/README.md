...
slug: anton-osika
roles:
  - Co-founder and CEO, Lovable
  - Creator, GPT Engineer (open-source)
...
- **Ambition as filter.** Use the job ad to repel the wrong applicants.
- **Bottleneck re-ranking weekly.** Identify the biggest stuck point, fix, repeat.
