...
slug: paul-jarvis
roles:
  - Author of 'Company of One: Why Staying Small Is the Next Big Thing for Business
  - Designer and developer who ran his own company of one for 20+ years
  - Co-created Fathom Analytics
...
- 2026-04 — `book-summary-company-of-one-paul-jarvis.md` (artemis ingest)
- 2026-04 — `paul-jarvis-built-a-million-dollar-business-with-zero-employees-the-company-of-o.md` (artemis ingest)
