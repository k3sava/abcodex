...
slug: devin-reed
roles:
  - 2x Head of Content at Gong (grew from $20M to $200M ARR) and Clari
  - founder of The Reeder (14,000+ newsletter subscribers)
...
- 2026-04 — `unconventional-marketing-strategies-for-b2b-creators.md` (artemis ingest)
- 2026-04 — `how-to-build-a-revenue-first-b2b-content-engine-dreamdata.md` (artemis ingest)
- 2026-04 — `the-ultimate-linkedin-playbook-for-b2b-marketers-grow-influence-pipeline.md` (artemis ingest)
