...
roles:
  ...
  - Tech lead, product engineering, Anthropic
  - Former GPT-3 architect, OpenAI
...
- **Use new tools as new tools.** Ambitious framing plus retry-from-scratch beats iterative tweaking.
- **Constitution → personality → brand.** Values produce the personality that produces buyer trust.
